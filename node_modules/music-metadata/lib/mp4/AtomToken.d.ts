...
export declare const tkhd: Token.IGetToken<IAtomFtyp>;
/**
...
declare class SimpleTableAtom<T> implements Token.IGetToken<ITableAtom<T>> {
    len: number;
    private token;
    constructor(len: number, token: Token.IGetToken<T>);
...
export declare const TimeToSampleToken: Token.IGetToken<ITimeToSampleToken>;
/**
...
export declare const SampleToChunkToken: Token.IGetToken<ISampleToChunk>;
/**
 ...
 */
export declare class StszAtom implements Token.IGetToken<IStszAtom> {
    len: number;
    constructor(len: number);
 ...
 */
export declare class ChapterText implements Token.IGetToken<string> {
    len: number;
    constructor(len: number);
