 ...
 * ToDo
 */
export declare const ID3v2Header: Token.IGetToken<IID3v2header>;
export declare const ExtendedHeader: Token.IGetToken<IExtendedHeader>;
export interface ITextEncoding {
    encoding: StringEncoding;
    bom?: boolean;
}
export declare const TextEncodingToken: Token.IGetToken<ITextEncoding>;
