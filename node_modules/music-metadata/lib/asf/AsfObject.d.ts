 ...
 * Ref: http://drang.s4.xrea.com/program/tips/id3tag/wmp/03_asf_top_level_header_object.html#3
 */
export declare const TopLevelHeaderObjectToken: Token.IGetToken<IAsfTopLevelObjectHeader>;
/**
 * Token for: 3.1 Header Object (mandatory, one only)
 * Ref: http://drang.s4.xrea.com/program/tips/id3tag/wmp/03_asf_top_level_header_object.html#3_1
 */
export declare const HeaderObjectToken: Token.IGetToken<IAsfObjectHeader>;
export declare abstract class State<T> implements Token.IGetToken<T> {
    len: number;
 ...
 */
export declare class HeaderExtensionObject implements Token.IGetToken<IHeaderExtensionObject> {
    static guid: GUID;
    len: number;
    constructor();
 ...
 */
export declare class WmPictureToken implements Token.IGetToken<IWmPicture> {
    len: any;
